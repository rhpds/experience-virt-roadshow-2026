...
+
image::2026_spring/module-05-tempinst/31_Windows_Template_BIOS.png[link=self, window=blank, width=100%]
...
+
image::2026_spring/module-05-tempinst/35_Select_RHEL9.png[link=self, window=blank, width=100%]
