...
* xref:module-04-bcdr.adoc[Backup and Recovery for Virtual Machines]
** xref:module-04-bcdr.adoc#review_operator[Review the OADP Operator]
** xref:module-04-bcdr.adoc#create_backup[Create a Virtual Machine Backup]
** xref:module-04-bcdr.adoc#restore_backup[Restore From a Backup]
...
* xref:module-06-networking.adoc[Network Management for Virtual Machines]
** xref:module-06-networking.adoc#review[Review Environment]
** xref:module-06-networking.adoc#nad[Create Network Attachment Definition]
** xref:module-06-networking.adoc#attach[Attach Virtual Machine to Network]
** xref:module-06-networking.adoc#udn[User Defined Networks]

* xref:module-07-workingvms.adoc[Working with Virtual Machines and Applications]
** xref:module-07-workingvms.adoc#service_route_imported[Exposing an Application with a Service/Route - MTV-Imported VMs]
** xref:module-07-workingvms.adoc#service_route_staged[Exposing an Application with a Service/Route - Staged VMs]
